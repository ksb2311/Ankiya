...
<body id="top">
    ...
    <header class="s-header">
        ...
        <button class="gotop" style="position: fixed;right: 1em;bottom: 1em;font-size: 10px;padding: 5px;"  id="trigger">Menu</button>
		<ul class="my-nav my-nav--list">
			<div id="wrapper-templates">
				<li class="my-nav__item"><a class="my-nav__link" href="#home">Home</a></li>
				<li class="my-nav__item"><a class="my-nav__link" href="#about">About</a></li>
				<li class="my-nav__item"><a class="my-nav__link" href="#services">Services</a></li>
				<li class="my-nav__item"><a class="my-nav__link" href="#works">Works</a></li>
				<li class="my-nav__item"><a class="my-nav__link" href="#contact">Contact</a></li>
			</div>
		</ul>
	...
	<div class="home-content">
            ...
            <div class="row home-content__main">
				...
				<div id="img" style="width: 500px;margin-left: auto;margin-right: auto;"></div>
...
<main class="grid">
  ...
  <article>
    ...
    <script src="js/glitchcount.js"></script>
